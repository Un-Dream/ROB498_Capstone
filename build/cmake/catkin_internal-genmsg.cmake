...
set(MSG_I_FLAGS "-Icatkin_internal:/home/jetson/ROB498_FlightExercises/src/msg;-Igeometry_msgs:/opt/ros/noetic/share/geometry_msgs/cmake/../msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/jetson/ROB498_FlightExercises/src/msg/AprilTagPosition.msg" NAME_WE)
add_custom_target(_catkin_internal_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "catkin_internal" "/home/jetson/ROB498_FlightExercises/src/msg/AprilTagPosition.msg" "std_msgs/Header:geometry_msgs/Point"
)
...
_generate_msg_cpp(catkin_internal
  "/home/jetson/ROB498_FlightExercises/src/msg/AprilTagPosition.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/catkin_internal)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/catkin_internal\")")
  # install generated code
  install(
