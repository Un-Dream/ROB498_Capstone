...
def create_printable_group(group_idx, center_scale = 3, outer_scale = 2, dpi=300, tag_size_mm=165):
    ...
    print("Tag Width: {} px ({} mm). Image Width: {} px ({} in / {} mm)".format(tag_width_px, tag_size_mm, image_width_px, image_width_px / dpi, (image_width_px / dpi) * 25.4))

    tag_2_width_px = int(tag_width_px * outer_scale / center_scale)
    tag_2_size_mm = tag_size_mm * outer_scale / center_scale
    print("Tag 2 Width: {} px ({} mm)".format(tag_2_width_px, tag_2_size_mm))
    ...
    print("Group Height: {} px ({} in / {} mm)".format(group.shape[0], group.shape[0] / dpi, group.shape[0] / dpi * 25.4))

    
    # Place the group idx in the top left corner
    text = ("{}").format(group_idx)
...
if __name__ == "__main__":
    ...
    for i in range(num_groups):
        ...
        out_file = out_dir / "group_{}.png".format(i)
